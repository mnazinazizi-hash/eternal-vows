...
export default function SupportUs() {
  ...
  return (
    <>
      ...
      ========================================================= */}
      {open && (
        <div className="fixed bottom-44 right-6 z-[94] w-[calc(100vw-2rem)] max-w-xl">
                  ...
                  <form onSubmit={handleSubmit}>
                    ...
                    <div className="mt-5 flex flex-col md:flex-row md:items-center gap-4">
                      ...
                      <p className="md:w-64 text-center md:text-left font-body-sm text-on-surface-variant leading-relaxed">
                        After making your M-Pesa contribution, you can let us
                        know your name and amount.
                      </p>
                    </div>
                  </form>
                </>
